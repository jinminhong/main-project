...
<body>
	<div class="jumbotron">
		<div class="container">
			<h1>회원정보 수정</h1>
			<form action="modify.do" method="post" class="was-validated">
				...
				<div class="form-group">
					<div>아이디</div>
					<input type="text" name="id" id="id" class="form-control" value="${user.id}" placeholder="${user.id}" readonly required>
				...
				<div class="form-group">
					<div>나이</div>
					<input type="text" name="age" id="age"  placeholder="${user.age}" required>
					<div class="valid-feedback">Valid.</div>
					<div class="invalid-feedback">Please fill out this field.</div>
				</div>
