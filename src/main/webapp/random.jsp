...
<body>
	<c:forEach var="randomStore" varStatus="status" items="${randomStore}">
		<input type="hidden" name="randomStore${status.index}" class="randomStore" value="${randomStore.sname }">
	</c:forEach>
	...
	<script>
		$(function(){
			$('.randomStore').each(function(index,element){
